...
export const ProductsSummaryCard = ({ product }) => {
    ...
    return (
        <div className="grid grid-flow-col col-span-1 p-1 sm:p-2 border-b border-b-gray-200 h-30">
            <div className="product-image mr-2 border border-grey-200 rounded-lg h-1/3 sm:w-1/3">
